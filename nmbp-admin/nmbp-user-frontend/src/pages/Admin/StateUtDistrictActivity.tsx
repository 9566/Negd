...
const sampleData: ActivityRow[] = [
  {
    ...
    district: "Amroha",
    activityName: "Drawing Competition",
  ...
  },
  {
    ...
    stateUt: "Uttar Pradesh",
    district: "Ayodhya",
    activityName: "Slogan Writing Competition",
    activityDate: "09/12/2025",
  ...
  },
  {
    ...
    district: "Bhopal",
    activityName: "Rangoli Making Competition",
  ...
  },
  {
    ...
    stateUt: "Uttar Pradesh",
    district: "Azamgarh",
    activityName: "Nukad Natak",
    activityDate: "01/01/2026",
  ...
  },
  {
    ...
    stateUt: "Rajasthan",
    district: "Jaipur",
    activityName: "Marathon/Walkathon",
    activityDate: "01/01/2026",
  ...
  },
  {
    ...
    stateUt: "Maharashtra",
    district: "Mumbai",
    activityName: "Health Camp",
    activityDate: "20/01/2026",
  ...
  },
  {
    ...
    stateUt: "Karnataka",
    district: "Bengaluru",
    activityName: "Sports Meet",
    activityDate: "30/01/2026",
...
const StateUtDistrictActivity: React.FC = () => {
  ...
  const columns: Column<ActivityRow>[] = [
    ...
    { key: "district", label: "District" },
    {
      ...
      label: "Activity Name",
      render: (item) => (
        <span style={{ fontWeight: 500, color: "#1A56DB" }}>
          {item.activityName}
        </span>
      ),
    },
    { key: "activityDate", label: "Date" },
    {
      ...
      label: "Participants",
      render: (item) => (
        <span style={{ fontWeight: 600 }}>{item.totalParticipants}</span>
      ),
    },
    { key: "male", label: "Male" },
