    ...
    return (
        <div>
            ...
            <div className="settings-section">
                <h2 className="heading-section" style={{ marginBottom: "16px" }}>General</h2>
                <div className="settings-row">
                    <div>
                        <div style={{ fontSize: "14px", fontWeight: 500 }}>Language</div>
                ...
                <div className="settings-row">
                    <div>
                        <div style={{ fontSize: "14px", fontWeight: 500 }}>Auto Logout</div>
                        <div className="text-secondary">Automatically logout after 30 minutes of inactivity</div>
                    </div>
                    <Toggle active={autoLogout} onToggle={() => setAutoLogout(!autoLogout)} />
                </div>
            </div>

            {/* Security */}
            <div className="settings-section">
                <h2 className="heading-section" style={{ marginBottom: "16px" }}>Security</h2>
                <div className="settings-row">
                    <div>
                        <div style={{ fontSize: "14px", fontWeight: 500 }}>Two-Factor Authentication</div>
                        <div className="text-secondary">Add an extra layer of security to your account</div>
                    </div>
                    <Toggle active={twoFactor} onToggle={() => setTwoFactor(!twoFactor)} />
                </div>
                <div className="settings-row">
                    <div>
                        <div style={{ fontSize: "14px", fontWeight: 500 }}>Session History</div>
                        <div className="text-secondary">View and manage your active sessions</div>
                    </div>
            ...
            {/* Notifications */}
            <div className="settings-section">
                <h2 className="heading-section" style={{ marginBottom: "16px" }}>Notification Preferences</h2>
                <div className="settings-row">
                    <div>
                        <div style={{ fontSize: "14px", fontWeight: 500 }}>Email Notifications</div>
                        <div className="text-secondary">Receive updates via email</div>
                    </div>
                    <Toggle active={emailNotif} onToggle={() => setEmailNotif(!emailNotif)} />
                </div>
                <div className="settings-row">
                    <div>
                        <div style={{ fontSize: "14px", fontWeight: 500 }}>SMS Notifications</div>
                ...
                <div className="settings-row">
                    ...
                    <Toggle active={pushNotif} onToggle={() => setPushNotif(!pushNotif)} />
                </div>
            </div>
