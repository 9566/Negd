...
const Profile: React.FC = () => {
    ...
    return (
        <div>
            ...
            <div className="card">
                <div className="card-body" style={{ display: "flex", gap: "40px", alignItems: "flex-start", flexWrap: "wrap" }}>
                    {/* Avatar */}
                    <div style={{ textAlign: "center" }}>
                        <div className="profile-avatar-lg">{initials}</div>
                        <button className="btn btn-outline btn-sm" style={{ marginTop: "16px" }}>Edit Profile</button>
                    </div>
                    ...
                    <div style={{ flex: 1, minWidth: "300px" }}>
                        ...
                        <div className="form-grid">
                            ...
                            <div className="form-group">
                                ...
                                <div className="text-body">{roleLabels[user?.role || "district"]}</div>
                            </div>
                            <div className="form-group">
                                <label className="form-label">Email</label>
                                <div className="text-body">{user?.name?.toLowerCase().replace(" ", ".") + "@gov.in"}</div>
                            </div>
                            <div className="form-group">
                        ...
                        <div className="form-section-title" style={{ marginTop: "24px" }}>Location Details</div>
                        <div className="form-grid">
                            <div className="form-group">
