...
const Pledge: React.FC = () => {
    ...
    return (
        <div style={{ padding: "0" }}>
                ...
                <div>
                    ...
                    <div style={{ padding: "0 32px 32px 32px", marginTop: "-20px", position: "relative" }}>
                        ...
                        <div style={{
                            ...
                            backgroundColor: "#008751", color: "#fff", padding: "6px 14px",
                        ...
                        <div style={{ textAlign: "center" }}>
                            <Button color="#008751" size="lg" radius="md" onClick={() => setStep("form")}
                        ...
                        <div style={{ backgroundColor: "#fff", borderRadius: "8px", border: "1px solid #E5E7EB", padding: "24px" }}>
                            ...
                            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                                <div>
                                    ...
                                    <input type="text" placeholder="Name as per records" style={{ width: "100%", padding: "10px 14px", border: "1px solid #D1D5DB", borderRadius: "6px", fontSize: "14px", boxSizing: "border-box" }} />
                                </div>
                                <div>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", marginTop: "24px" }}>
                                ...
                                <Button color="#002f5d" onClick={() => setStep("otp")}>Send OTP & Verify →</Button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {step === "success" && (
                <div style={{ textAlign: "center" }}>
                    <div style={{ backgroundColor: "#008751", color: "#fff", padding: "60px 20px", marginBottom: "40px" }}>
                        <div style={{
                        ...
                        <h2 style={{ fontSize: "32px", fontWeight: 700, marginBottom: "8px" }}>Pledge Successfully Recorded!</h2>
                        <p style={{ fontSize: "16px", opacity: 0.9, maxWidth: "600px", margin: "0 auto" }}>
                            Thank you for your commitment to a Drug-Free India and taking the Nasha Mukt Bharat Abhiyaan Pledge.
                        </p>
                    </div>
                    ...
                    <div style={{ padding: "0 32px 40px" }}>
                        {/* Certificate Preview */}
                        <div style={{
                            border: "1px solid #E5E7EB", borderRadius: "12px", padding: "40px",
                            maxWidth: "600px", margin: "0 auto 32px", backgroundColor: "#fff",
