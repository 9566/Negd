...
const categoryColors: Record<string, { bg: string; color: string }> = {
    "Awareness Rally": { bg: "#eef2ff", color: "#002f5d" },
    "Community Event": { bg: "#D1FAE5", color: "#008751" },
                ...
                <div style={{ display: "flex", gap: "6px", justifyContent: "center", marginBottom: "32px" }}>
                    {[0, 1, 2, 3, 4].map((d, i) => (
                        <div key={i} style={{
                            ...
                            borderRadius: "50%", backgroundColor: i === 0 ? "#002f5d" : "#D1D5DB",
                        }} />
                    ))}
                </div>
                        ...
                        <table style={{ width: "100%", borderCollapse: "collapse" }}>
                            <tbody>
                                {[
                                    ...
                                    { label: "Target Audience", value: a.targetAudience, color: "#002f5d" },
                                    { label: "Venue Type", value: a.venueType, color: "#002f5d" },
                                    { label: "Organized By", value: a.organizedBy, color: "#002f5d" },
                                    { label: "Chief Guest", value: a.chiefGuest, color: "#002f5d" },
                                ].map((row, i) => (
            ...
            <div style={{ display: "flex", gap: "8px", marginBottom: "24px" }}>
                {categories.map(c => (
                    <button key={c} onClick={() => { setCategoryFilter(c); setVisibleCount(9); }} style={{
                        ...
                        backgroundColor: categoryFilter === c ? "#002f5d" : "#fff",
                    ...
                    >
                        ...
                        <div style={{ padding: "16px" }}>
                            ...
                            <div style={{ borderTop: "1px solid #F3F4F6", marginTop: "10px", paddingTop: "10px", fontSize: "13px" }}>
                                <span style={{ fontWeight: 700, color: "#002f5d" }}>{a.participants}</span>
            ...
            {visibleCount < filtered.length && (
                <div style={{ textAlign: "center", marginBottom: "24px" }}>
                    <button onClick={() => setVisibleCount(c => c + 9)} style={{
                        padding: "10px 32px", border: "2px solid #002f5d", borderRadius: "8px", fontSize: "14px",
                        backgroundColor: "#fff", color: "#002f5d", cursor: "pointer", fontWeight: 700,
