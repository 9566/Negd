...
const typeColors: Record<string, { bg: string; color: string }> = {
    "De-Addiction Centre": { bg: "#008751", color: "#FFFFFF" },
    "OAT": { bg: "#eef2ff", color: "#002f5d" },
    "Hospital": { bg: "#fef2f2", color: "#991b1b" },
    "Rehabilitation": { bg: "#fffbeb", color: "#92400e" },
};
    ...
    return (
        <div style={{ padding: "24px" }}>
            ...
            <div style={{ display: "flex", gap: "12px", marginBottom: "24px", alignItems: "center" }}>
                ...
                <Button color="#002f5d" size="sm" leftSection={<span>📍</span>}>Near Me</Button>
            </div>
                ...
                <div style={{ backgroundColor: "#fff" }}>
                    ...
                    {filtered.map((f) => (
                        <div key={f.id} style={{ padding: "20px", borderBottom: "1px solid #F3F4F6" }}>
                            ...
                            {f.website && <p style={{ fontSize: "12px", color: "#002f5d", margin: "0 0 8px" }}>🌐 {f.website}</p>}
                            ...
                            <div style={{ display: "flex", gap: "8px" }}>
                                <Button color="#002f5d" size="xs" radius="md">🧭 Get Directions</Button>
