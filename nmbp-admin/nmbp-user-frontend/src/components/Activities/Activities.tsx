...
const allActivities = [
  ...
  },
  {
    ...
    title: "Nukad Natak",
    date: "01/01/2026",
    location: "Market Square, Azamgarh",
    participants: 40,
    district: "Azamgarh",
    state: "Uttar Pradesh",
  },
  {
    id: 5,
    title: "Marathon/Walkathon",
    date: "01/01/2026",
    location: "Stadium, Jaipur",
    participants: 210,
    district: "Jaipur",
    state: "Rajasthan",
  },
      ...
      >
        ...
        >
          ...
          {(role === "central" || role === "state") && (
            ...
            >
              <option>
                {role === "central" ? "All States" : "All Districts"}
              </option>
            </select>
          )}
        </div>
        ...
        >
          <div style={{ display: "flex", gap: "4px" }}>
            ...
            {[2, 3].map((n) => (
              <span key={n} style={{ padding: "4px 8px", cursor: "pointer" }}>
                {n}
              </span>
            ))}
          </div>
